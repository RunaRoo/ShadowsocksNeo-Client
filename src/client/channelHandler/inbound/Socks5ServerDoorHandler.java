...
import client.channelHandler.outbound.Socks5DecryptOutbound;
import client.channelHandler.outbound.Socks5ServerEncoder;
        ...
        if (remoteBootstrap == null) {
            ...
            remoteBootstrap.connect(proxyAddress).addListener((ChannelFutureListener) future -> {
                if (future.isSuccess()) {
                    ...
                    clientChannel.writeAndFlush(new DefaultSocks5CommandResponse(Socks5CommandStatus.SUCCESS, Socks5AddressType.IPv4));//, Socks5AddressType.IPv4));
